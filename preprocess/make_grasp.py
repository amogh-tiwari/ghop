...
def make_ho3d():
    ...
    #     ","
    # )
    src_dir = "/home/atiwari/projects/object_manipulation3/grab_net/datasets/grabnet_extract/tools/object_meshes/contact_meshes"
    dst_dir = "/home/atiwari/projects/ghop/data/GRAB_grasp/meshes/all/"
    index_list = "mug, wineglass, camera, binoculars, fryingpan, toothpaste".split(",")
    ...
    for index in index_list:
        ...
        dst_file = osp.join(dst_dir, index, "oObj.ply")
